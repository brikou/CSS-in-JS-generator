declare module "postcss-selector-parser" {
    ...
    */
    ...
    function parser(): Processor<never>;
    function parser<Transform>(processor: AsyncProcessor<Transform>): Processor<Transform, never>;
    function parser(processor: AsyncProcessor<void>): Processor<never, never>;
    function parser<Transform>(processor: SyncProcessor<Transform>): Processor<Transform>;
    function parser(processor: SyncProcessor<void>): Processor<never>;
    function parser<Transform>(processor?: SyncProcessor<Transform> | AsyncProcessor<Transform>): Processor<Transform>;
    ...
    */
        ...
        type ProcessorFn<ReturnType = void> = (root: Root) => ReturnType;
